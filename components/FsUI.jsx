...
import { withStyles } from "@mui/mui/mateles";
import Button from "@mui/mui/mateton";
import CircularProgress from "@mui/mui/matecularProgress";
import Dialog from "@mui/mui/matelog";
import DialogContent from "@mui/mui/matelogContent";
import DialogContentText from "@mui/mui/matelogContentText";
import DialogTitle from "@mui/mui/matelogTitle";
import DialogActions from "@mui/mui/matelogActions";
import Icon from "@mdi/react";
import IconButton from "@mui/mui/matenButton";
import InputBase from "@mui/mui/mateutBase";
import LinearProgress from "@mui/mui/mateearProgress";
import Paper from "@mui/mui/mateer";
import Table from "@mui/mui/matele";
import TableBody from "@mui/materialleBody";
import TableCell from "@mui/materialleCell";
import TableContainer from "@mui/materialleContainer";
import TableHead from "@mui/materialleHead";
import TableRow from "@mui/materialleRow";
import TextField from "@mui/materialtField";
import Toolbar from "@mui/materiallbar";
import Tooltip from "@mui/materialltip";
import Typography from "@mui/materialography";
...
class FsUI extends PureComponent {
    ...
    componentDidUpdate(previousProps) {
        ...
        if (this.props.fsZippedFile !== null) {
            const zip = new JSZip();
            zip.loadAsync(this.props.fsZippedFile)
                .then((contents) => {
    ...
    render() {
        ...
        let totalItemsCount = "";
        if (this.state.selected.length > 0) totalItemsCount = `(${this.state.selected.length} / ${this.props.fsCurrentList.length} items)`;
                    ...
                    <div style={styleComponent}>
                        {visibleTextField ? (
                            ...
                            <div>
                                ...
                                <div>
                                    <div>
                                        <Typography type="caption text" style={{ fontSize: "0.75em", marginLeft: "15px", color: "rgba(146, 146, 146, 1)", float: "left" }}>
                                            {"/" + this.props.fsCurrentDir + " "}
                                        </Typography>
                                    </div>
                                    <div>
                                        <Typography type="caption text" style={{ fontSize: "0.75em", marginRight: "5px", color: "rgba(146, 146, 146, 1)", float: "right" }}>
                                            {totalItemsCount}
                                        </Typography>
                                    </div>
                                </div>
                                            ...
                                            return (
                                                ...
                                                >
                                                    <TableCell component="th" scope="row">
                                                        <Typography className={classes.tableCellText}>{row.name}</Typography>
                                                    </TableCell>
                        ...
                        <Dialog open={visibleAlreadyExistDlg} onClose={this.hideAlreadyExistDlg}>
                        ...
                        <Dialog open={visibleOSaveAsDlg}>
                            ...
                            <DialogContent>
                                <DialogContentText>Specify a file name for the archive:</DialogContentText>
                                <TextField autoFocus margin="dense" id="id-open-url" inputRef={(input) => (this.saveAsField = input)} fullWidth />
                            </DialogContent>
                            <DialogActions>
