...
import { dicomDateToLocale, dicomTimeToStr, getSettingsDicomdirView } from "../functions";
...
class Dicomdir extends PureComponent {
    ...
    componentDidMount() {
        if (this.props.dicomdir.origin === "local") this.openDicomdir(this.props.dicomdir.dicomdir);
