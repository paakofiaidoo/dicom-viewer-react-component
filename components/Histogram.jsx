...
class Histogram extends PureComponent {
    ...
    render() {
        return (
            <div style={style}>
                <div>
                    <canvas ref={this.canvasHistogram} width={HIST_WIDTH} height={HIST_HEIGHT} style={{ backgroundColor: "#FFFFFF", cursor: "crosshair" }} />
                </div>
                ...
                <div style={styleSlider}>
                    <Slider value={this.state.value} onChange={this.handleChangeValue} aria-labelledby="continuous-slider" color="secondary" min={0} max={255} />
                </div>
                <div>
